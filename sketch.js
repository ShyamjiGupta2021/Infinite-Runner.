...
//code to load the image of restart.
    restartImg = loadImage("restart.png");

//code to load the image of up-arrow.
...
//coade to create a jumpButton.
    jumpButton = createSprite(200,100);
    jumpButton.addImage(upArrowImg);
    jumpButton.scale = 0.06;
...
//code to jump the 'runner' when jumpButton is pressed.
    if(mousePressedOver(jumpButton)&& runner.y >=14) {
       runner.velocityY = -13;
}
...
//code for draw sprites.
    ...
    text("Press_Space_Key || up-arrow = 'JUMP'",10,50)
}
